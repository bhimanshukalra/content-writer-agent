...
# ---------------------------------------------------------
from server import app as workflow
    ...
    yield create_sse_event(
        {
            ...
            "status": "running",
            "detail": (
                "Determining whether the topic requires " "current web research."
            ),
        }
    )
                    ...
                    yield create_sse_event(
                        {
                            ...
                            "status": "completed",
                            "detail": (
                                f"Prepared {len(evidence)} " "deduplicated sources."
                            ),
                        }
                    )
                        ...
                        yield create_sse_event(
                            {
                                ...
                                "status": "completed",
                                "detail": (
                                    f"Completed all " f"{len(task_map)} sections."
                                ),
                            }
                        )
